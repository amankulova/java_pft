...
public class ContactCreationTests {
  ...
  public void ContactCreationTests() {
    ...
    wd.findElement(By.name("lastname")).sendKeys("Testsurname");
    wd.findElement(By.name("address")).click();
    wd.findElement(By.name("address")).click();
    wd.findElement(By.name("home")).click();
    new Actions(wd).doubleClick(wd.findElement(By.name("theform"))).build().perform();
    new Actions(wd).doubleClick(wd.findElement(By.name("home"))).build().perform();
    new Actions(wd).doubleClick(wd.findElement(By.name("address"))).build().perform();
    wd.findElement(By.name("home")).click();
    wd.findElement(By.name("home")).clear();
    wd.findElement(By.name("home")).sendKeys();
    wd.findElement(By.name("mobile")).click();
    wd.findElement(By.name("mobile")).clear();
    wd.findElement(By.name("mobile")).sendKeys("87777777777");
